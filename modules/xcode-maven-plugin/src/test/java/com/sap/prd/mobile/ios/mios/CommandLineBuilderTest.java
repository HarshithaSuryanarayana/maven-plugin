...
public class CommandLineBuilderTest
{
  ...
  public void testCommandlineBuilderStraightForward() throws Exception
  {
    ...
    XCodeContext context = new XCodeContext(Arrays.asList("clean", "build"), projectDirectory, System.out, null,
          options);
    String xcconfig=getversion() ? ",\"-xcconfig\",\"xcode.xcconfig\"" :"";
    expect(context, "xcodebuild", "-project", "MyLib.xcodeproj", "-sdk",
          "mysdk", "-configuration", "Release", "clean", "build",  "SYMROOT=build", "OBJROOT=build","SHARED_PRECOMPS_DIR=build","DSTROOT=build"+xcconfig );
  }
  ...
  public void testCommandlineBuilderStraightForwardSettings() throws Exception
  {
    ...
    expect(context, "xcodebuild", "-project", "MyLib.xcodeproj", "-sdk",
          ...
          "CONFIGURATION_BUILD_DIR=/Users/me/projects/myapp/target/xcode/src/main/xcode/build","SYMROOT=build","VALID_ARCHS=i386","OBJROOT=build",
          "SHARED_PRECOMPS_DIR=build",  "DSTROOT=build"+xcconfig);
  }
  ...
  public void testCommandlineBuilderStraightForwardOptions() throws Exception
  {
    ...
    expect(context, "xcodebuild", "-project", "MyLib.xcodeproj", "-arch", "i386", "-sdk",
          "mysdk", "-configuration", "Release", "clean", "build",  "SYMROOT=build","OBJROOT=build",
          "SHARED_PRECOMPS_DIR=build" ,"DSTROOT=build"+xcconfig);
  }
  ...
  public void testLibraryCommandline() throws Exception
  {
    ...
    String xcconfig=getversion() ? ",\"-xcconfig\",\"xcode.xcconfig\"" :"";
    expect(context, "xcodebuild", "-project", "MyLib.xcodeproj", "-arch", "i386", "-sdk",
          "iphoneos", "-configuration", "Debug","-target", "MyLib", "clean", "build","CONFIGURATION_BUILD_DIR=MyLib/build", "SYMROOT=build" ,"VALID_ARCHS=i386" ,"OBJROOT=build",  "SHARED_PRECOMPS_DIR=build","DSTROOT=build"+xcconfig );
  }
  ...
  public Boolean getversion()
  {
	  try {
	        ...
	        return(checkVersions(version,MINIMUM_VERSION));
